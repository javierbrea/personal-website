...
* __Overwriting code in `node_modules`__ - Really? Well, not as a part of the usual workflow, but to be honest sometimes I found myself overwriting a package in the `node_modules` folder in order to run some integration tests prior to publish it. 😞
